...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1d0
SOPC_SYSID_FLAG += --sidp=0x1d0
ELF_PATCH_FLAG  += --sidp 0x1d0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1679588850
SOPC_SYSID_FLAG += --timestamp=1679588850
ELF_PATCH_FLAG  += --timestamp 1679588850
